...
dbus-send --system --dest=com.streamunlimited.StreamCastDaemon1 --print-reply /com/streamunlimited/StreamCastDaemon1 com.streamunlimited.StreamCastDaemon1.NotifyUserAction uint32:1
