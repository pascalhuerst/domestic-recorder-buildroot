...
LINUX_MAKE_FLAGS = \
	...
	LOADADDR=$(BR2_LINUX_KERNEL_LOADADDR)
...
define LINUX_CONFIGURE_CMDS
	...
	$(if $(BR2_TARGET_ROOTFS_INITRAMFS),
		...
		$(call KCONFIG_DISABLE_OPT,CONFIG_INITRAMFS_COMPRESSION_BZIP2,$(@D)/.config)
		$(call KCONFIG_DISABLE_OPT,CONFIG_INITRAMFS_COMPRESSION_LZMA,$(@D)/.config)
		$(call KCONFIG_DISABLE_OPT,CONFIG_INITRAMFS_COMPRESSION_XZ,$(@D)/.config)
		$(call KCONFIG_DISABLE_OPT,CONFIG_INITRAMFS_COMPRESSION_LZO,$(@D)/.config)
		$(call KCONFIG_DISABLE_OPT,CONFIG_XZ_DEC_TEST,$(@D)/.config))
