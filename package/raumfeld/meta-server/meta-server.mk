...
META_SERVER_DEPENDENCIES = host-pkgconfig libraumfeld libraumfeldcpp sqlite3 taglib-extras
...
meta-server: uclibc host-pkgconfig raumfeld sqlite taglib taglib-extras $(TARGET_DIR)/$(META_SERVER_BINARY)
