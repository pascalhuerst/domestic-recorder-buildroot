...
REMOTE_CONTROL_CONF_OPTS = --disable-glibtest

REMOTE_CONTROL_DEPENDENCIES = host-intltool host-pkgconf host-libglib2 $(if $(BR2_NEEDS_GETTEXT_IF_LOCALE),gettext) libraumfeld sly-toolkit
