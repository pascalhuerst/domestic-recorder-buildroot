...
{
	/* *to must be at least 72 bytes long char buffer */
	sha_256_t digest = sha256((sha_byte_t *) message, size);

	snprintf(to, 72, "%08x %08x %08x %08x %08x %08x %08x %08x",
		digest.h0, digest.h1, digest.h2,
		digest.h3, digest.h4, digest.h5,
		digest.h6, digest.h7);
}
